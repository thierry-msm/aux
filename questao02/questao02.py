        ...
        for azul in azuis:
            if verifica_colisao(vermelho_temp, azul):
                if dx > 0:
                    ...
                    # Colisão com amarelos
                    for yellow in amarelos:
                        azul_temp = {"x": proximo_azul_x, "y": azul["y"], "tam": azul["tam"]}
                        if verifica_colisao(azul_temp, yellow):
                            proximo_azul_x = yellow["x"] - azul["tam"]
                            proximo_x = proximo_azul_x - vermelho["tam"]
                    ...
                    for yellow in amarelos:
                        azul_temp = {"x": proximo_azul_x, "y": azul["y"], "tam": azul["tam"]}
                        if verifica_colisao(azul_temp, yellow):
                            proximo_azul_x = yellow["x"] + yellow["tam"]
                            proximo_x = proximo_azul_x + azul["tam"]
                    azul["x"] = proximo_azul_x
        ...
        for azul in azuis:
            if verifica_colisao(vermelho_temp, azul):
                if dy > 0:
                    ...
                    # Colisão com amarelos
                    for yellow in amarelos:
                        azul_temp = {"x": azul["x"], "y": proximo_azul_y, "tam": azul["tam"]}
                        if verifica_colisao(azul_temp, yellow):
                            proximo_azul_y = yellow["y"] - azul["tam"]
                            proximo_y = proximo_azul_y - vermelho["tam"]
                    ...
                    for yellow in amarelos:
                        azul_temp = {"x": azul["x"], "y": proximo_azul_y, "tam": azul["tam"]}
                        if verifica_colisao(azul_temp, yellow):
                            proximo_azul_y = yellow["y"] + yellow["tam"]
                            proximo_y = proximo_azul_y + azul["tam"]
                    azul["y"] = proximo_azul_y
